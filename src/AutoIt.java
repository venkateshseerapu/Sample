...
public class AutoIt {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("https://us.sf-qa.com/login");
		Thread.sleep(5000);
		 ...
		 */
		driver.findElement(By.xpath("//input[@name='emailaddress']")).sendKeys("sfus013113@snapfish.com");
		driver.findElement(By.xpath("//input[@name='password']")).sendKeys("sfqatest");
